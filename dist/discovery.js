...
import { lineOfJsonKey as coreLineOfJsonKey, lineOfJsonStringValue as coreLineOfJsonStringValue, resolveWithinRoot, withinByteCap, } from 'agent-gov-core';
const DEFAULT_EXCLUDED_DIRS = ['node_modules', '.git'];
...
export async function listSafeFiles(root, options) {
...
export async function readTextWithinRoot(root, relativePath) {
